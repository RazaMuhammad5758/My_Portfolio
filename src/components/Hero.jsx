        ...
        <div className="w-full lg:w-1/2 mt-20">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-8 text-4xl font-thin tracking-tight lg:mt-16 lg:text-6xl text-white"
            >
              Raza Muhammad
            </motion.h1>
            <motion.span
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="my-2 max-w-xl py-6 font-light tracker-tighter text-white text-justify"
            >
              {HERO_CONTENT}
            </motion.p>
            <motion.a
